<?php
class ControllerHeader_new extends Controller
{
	...
	{
		$this->load_model('footer_new');
		$this->load_model('home');
		$data = array();
		$data = $this->language->getAll();
		$data['headerMenus'] = array();
		$data['headerMenus'] = $this->model_footer_new->getFooterMenu('Top');
		...
		$this->id = 'header';
		$this->template = 'food/template/common/header_new.tpl';
		$this->data = $data;
