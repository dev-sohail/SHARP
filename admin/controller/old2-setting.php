...
class ControllerSetting extends Controller
{
	...
	public function index()
	{
		...
		if (!empty($_FILES['config_hwblogo']["name"])) {

			$defaultImageFileName = "no_image-100x100.png";
			$uploadedImageFileName = $defaultImageFileName;
			$targetDirectory = DIR_IMAGE . "setting/";
			$filename = time();
			$path = $_FILES['config_hwblogo']['name'];
			$ext = pathinfo($path, PATHINFO_EXTENSION);
			$targetFile = $targetDirectory . $filename . '.' . $ext;
			if (move_uploaded_file($_FILES["config_hwblogo"]["tmp_name"], $targetFile)) {
				$uploadedImageFileName = $filename . '.' . $ext;
			}
			$this->request->post['config_hwblogo'] = $uploadedImageFileName;
		} else {
			$this->request->post['config_hwblogo'] = $this->config->get('config_hwblogo');
		}

		if (!empty($_FILES['config_service_favicon']["name"])) {

			$defaultImageFileName = "no_image-100x100.png";
			$uploadedImageFileName = $defaultImageFileName;
			$targetDirectory = DIR_IMAGE . "setting/";
			$filename = time();
			$path = $_FILES['config_service_favicon']['name'];
			$ext = pathinfo($path, PATHINFO_EXTENSION);
			$targetFile = $targetDirectory . $filename . '.' . $ext;
			if (move_uploaded_file($_FILES["config_service_favicon"]["tmp_name"], $targetFile)) {
				$uploadedImageFileName = $filename . '.' . $ext;
			}
			$this->request->post['config_service_favicon'] = $uploadedImageFileName;
		} else {
			$this->request->post['config_service_favicon'] = $this->config->get('config_service_favicon');
		}
		...
		$data['entry_tawk_to_code'] = $this->language->get('entry_tawk_to_code');
		...
		$data['entry_firebase_server'] = $this->language->get('entry_firebase_server');
		$data['text_firebase_server'] = $this->language->get('text_firebase_server');
		...
		$data['help_tawk_to_account'] = $this->language->get('help_tawk_to_account');
		$data['help_google_captcha'] = $this->language->get('help_google_captcha');
		$data['help_firebase'] = $this->language->get('help_firebase');
		...
		if (isset($this->error['payment_checkout_test_public_key'])) {
			$data['error_payment_checkout_test_public_key'] = $this->error['payment_checkout_test_public_key'];
		} else {
			$data['error_payment_checkout_test_public_key'] = '';
		}
		if (isset($this->error['payment_checkout_test_secret_key'])) {
			$data['error_payment_checkout_test_secret_key'] = $this->error['payment_checkout_test_secret_key'];
		} else {
			$data['error_payment_checkout_test_secret_key'] = '';
		}
		if (isset($this->error['payment_checkout_test_channel_id'])) {
			$data['error_payment_checkout_test_channel_id'] = $this->error['payment_checkout_test_channel_id'];
		} else {
			$data['error_payment_checkout_test_channel_id'] = '';
		}
		if (isset($this->error['payment_checkout_test_signature_key'])) {
			$data['error_payment_checkout_test_signature_key'] = $this->error['payment_checkout_test_signature_key'];
		} else {
			$data['error_payment_checkout_test_signature_key'] = '';
		}

		if (isset($this->error['payment_checkout_live_public_key'])) {
			$data['error_payment_checkout_live_public_key'] = $this->error['payment_checkout_live_public_key'];
		} else {
			$data['error_payment_checkout_live_public_key'] = '';
		}
		if (isset($this->error['payment_checkout_live_secret_key'])) {
			$data['error_payment_checkout_live_secret_key'] = $this->error['payment_checkout_live_secret_key'];
		} else {
			$data['error_payment_checkout_live_secret_key'] = '';
		}

		if (isset($this->error['payment_checkout_live_channel_id'])) {
			$data['error_payment_checkout_live_channel_id'] = $this->error['payment_checkout_live_channel_id'];
		} else {
			$data['error_payment_checkout_live_channel_id'] = '';
		}
		if (isset($this->error['payment_checkout_live_signature_key'])) {
			$data['error_payment_checkout_live_signature_key'] = $this->error['payment_checkout_live_signature_key'];
		} else {
			$data['error_payment_checkout_live_signature_key'] = '';
		}

		if (isset($this->error['payment_currency'])) {
			$data['error_payment_currency'] = $this->error['payment_currency'];
		} else {
			$data['error_payment_currency'] = '';
		}



		// For Google Social Login Client ID
		if (isset($this->error['social_google_client_id'])) {
			$data['error_social_google_client_id'] = $this->error['social_google_client_id'];
		} else {
			$data['error_social_google_client_id'] = '';
		}

		// For Google Social Login Client Secret
		if (isset($this->error['social_google_client_secret'])) {
			$data['error_social_google_client_secret'] = $this->error['social_google_client_secret'];
		} else {
			$data['error_social_google_client_secret'] = '';
		}


		// For Facebook Social Login Client ID
		if (isset($this->error['social_facebook_client_id'])) {
			$data['error_social_facebook_client_id'] = $this->error['social_facebook_client_id'];
		} else {
			$data['error_social_facebook_client_id'] = '';
		}

		// For Facebook Social Login Client Secret
		if (isset($this->error['social_facebook_client_secret'])) {
			$data['error_social_facebook_client_secret'] = $this->error['social_facebook_client_secret'];
		} else {
			$data['error_social_facebook_client_secret'] = '';
		}


		// For Twilio Account SID
		if (isset($this->error['social_twilio_account_sid'])) {
			$data['error_social_twilio_account_sid'] = $this->error['social_twilio_account_sid'];
		} else {
			$data['error_social_twilio_account_sid'] = '';
		}

		// For Twilio Auth Token
		if (isset($this->error['social_twilio_auth_token'])) {
			$data['error_social_twilio_auth_token'] = $this->error['social_twilio_auth_token'];
		} else {
			$data['error_social_twilio_auth_token'] = '';
		}

		// For Twilio Number
		if (isset($this->error['social_twilio_service_sid'])) {
			$data['error_social_twilio_service_sid'] = $this->error['social_twilio_service_sid'];
		} else {
			$data['error_social_twilio_service_sid'] = '';
		}

		
		if (isset($this->error['config_practo_password'])) {
			$data['error_config_practo_password'] = $this->error['config_practo_password'];
		} else {
			$data['error_config_practo_password'] = '';
		}
		if (isset($this->error['config_practo_user'])) {
			$data['error_config_practo_user'] = $this->error['config_practo_user'];
		} else {
			$data['error_config_practo_user'] = '';
		}
		...
		if (isset($this->request->post['config_referral_discount'])) {
			$data['config_referral_discount'] = $this->request->post['config_referral_discount'];
		} else {
			$data['config_referral_discount'] = $this->config->get('config_referral_discount');
		}
		...
		if (isset($this->request->post['config_service_favicon'])) {
			$data['config_service_favicon'] = $this->request->post['config_service_favicon'];
		} else {
			$data['config_service_favicon'] = $this->config->get('config_service_favicon');
		}
		...
		if (isset($this->request->post['config_discunt_title'])) {
			$data['config_discunt_title'] = $this->request->post['config_discunt_title'];
		} else {
			$data['config_discunt_title'] = $this->config->get('config_discunt_title');
		}
		...
		if (isset($this->request->post['config_ga_thank_you'])) {
			$data['config_ga_thank_you'] = $this->request->post['config_ga_thank_you'];
		} else {
			$data['config_ga_thank_you'] = $this->config->get('config_ga_thank_you');
		}

		if (isset($this->request->post['config_tawk_to'])) {
			$data['config_tawk_to'] = $this->request->post['config_tawk_to'];
		} else {
			$data['config_tawk_to'] = $this->config->get('config_tawk_to');
		}

		if (isset($this->request->post['config_ga_thank_you_status'])) {
			$data['config_ga_thank_you_status'] = $this->request->post['config_ga_thank_you_status'];
		} else {
			$data['config_ga_thank_you_status'] = $this->config->get('config_ga_thank_you_status');
		}
		...
		if (isset($this->request->post['config_firebase_server'])) {
			$data['config_firebase_server'] = $this->request->post['config_firebase_server'];
		} else {
			$data['config_firebase_server'] = $this->config->get('config_firebase_server');
		}
		...
		if (isset($this->request->post['config_sociallinks'])) {
			$data['config_sociallinks'] = $this->request->post['config_sociallinks'];
		} else {
			$data['config_sociallinks'] = $this->config->get('config_sociallinks');
		}

		if (isset($this->request->post['config_twitterlink'])) {
			$data['config_twitterlink'] = $this->request->post['config_twitterlink'];
		} else {
			$data['config_twitterlink'] = $this->config->get('config_twitterlink');
		}
		if (isset($this->request->post['config_instalink'])) {
			$data['config_instalink'] = $this->request->post['config_instalink'];
		} else {
			$data['config_instalink'] = $this->config->get('config_instalink');
		}
		if (isset($this->request->post['config_facebooklink'])) {
			$data['config_facebooklink'] = $this->request->post['config_facebooklink'];
		} else {
			$data['config_facebooklink'] = $this->config->get('config_facebooklink');
		}
		...
		if (isset($this->request->post['config_cdescription'])) {
			$data['config_cdescription'] = $this->request->post['config_cdescription'];
		} else {
			$data['config_cdescription'] = $this->config->get('config_cdescription');
		}
		if (isset($this->request->post['config_ciframe'])) {
			$data['config_ciframe'] = $this->request->post['config_ciframe'];
		} else {
			$data['config_ciframe'] = $this->config->get('config_ciframe');
		}



		if (isset($this->request->post['config_footerlinks'])) {

			$data['config_footerlinks'] = $this->request->post['config_footerlinks'];
		} else {
			$data['config_footerlinks'] = $this->config->get('config_footerlinks');
		}
		if (isset($this->request->post['config_termsurl'])) {

			$data['config_termsurl'] = $this->request->post['config_termsurl'];
		} else {
			$data['config_termsurl'] = $this->config->get('config_termsurl');
		}
		if (isset($this->request->post['config_privacyurl'])) {
			$data['config_privacyurl'] = $this->request->post['config_privacyurl'];
		} else {
			$data['config_privacyurl'] = $this->config->get('config_privacyurl');
		}
		...
		if (isset($this->request->post['config_payment_checkout_environment'])) {
			$data['config_payment_checkout_environment'] = $this->request->post['config_payment_checkout_environment'];
		} else {
			$data['config_payment_checkout_environment'] = $this->config->get('config_payment_checkout_environment');
		}
		if (isset($this->request->post['config_payment_checkout_test_public_key'])) {
			$data['config_payment_checkout_test_public_key'] = $this->request->post['config_payment_checkout_test_public_key'];
		} else {
			$data['config_payment_checkout_test_public_key'] = $this->config->get('config_payment_checkout_test_public_key');
		}
		if (isset($this->request->post['config_payment_checkout_test_secret_key'])) {
			$data['config_payment_checkout_test_secret_key'] = $this->request->post['config_payment_checkout_test_secret_key'];
		} else {
			$data['config_payment_checkout_test_secret_key'] = $this->config->get('config_payment_checkout_test_secret_key');
		}
		if (isset($this->request->post['config_payment_checkout_test_channel_id'])) {
			$data['config_payment_checkout_test_channel_id'] = $this->request->post['config_payment_checkout_test_channel_id'];
		} else {
			$data['config_payment_checkout_test_channel_id'] = $this->config->get('config_payment_checkout_test_channel_id');
		}
		if (isset($this->request->post['config_payment_checkout_test_signature_key'])) {
			$data['config_payment_checkout_test_signature_key'] = $this->request->post['config_payment_checkout_test_signature_key'];
		} else {
			$data['config_payment_checkout_test_signature_key'] = $this->config->get('config_payment_checkout_test_signature_key');
		}
		if (isset($this->request->post['config_payment_checkout_live_public_key'])) {
			$data['config_payment_checkout_live_public_key'] = $this->request->post['config_payment_checkout_live_public_key'];
		} else {
			$data['config_payment_checkout_live_public_key'] = $this->config->get('config_payment_checkout_live_public_key');
		}
		if (isset($this->request->post['config_payment_checkout_live_secret_key'])) {
			$data['config_payment_checkout_live_secret_key'] = $this->request->post['config_payment_checkout_live_secret_key'];
		} else {
			$data['config_payment_checkout_live_secret_key'] = $this->config->get('config_payment_checkout_live_secret_key');
		}

		if (isset($this->request->post['config_payment_checkout_live_channel_id'])) {
			$data['config_payment_checkout_live_channel_id'] = $this->request->post['config_payment_checkout_live_channel_id'];
		} else {
			$data['config_payment_checkout_live_channel_id'] = $this->config->get('config_payment_checkout_live_channel_id');
		}
		if (isset($this->request->post['config_payment_checkout_live_signature_key'])) {
			$data['config_payment_checkout_live_signature_key'] = $this->request->post['config_payment_checkout_live_signature_key'];
		} else {
			$data['config_payment_checkout_live_signature_key'] = $this->config->get('config_payment_checkout_live_signature_key');
		}

		if (isset($this->request->post['config_payment_currency'])) {
			$data['config_payment_currency'] = $this->request->post['config_payment_currency'];
		} else {
			$data['config_payment_currency'] = $this->config->get('config_payment_currency');
		}
		if (isset($this->request->post['config_payment_checkout_status'])) {
			$data['config_payment_checkout_status'] = $this->request->post['config_payment_checkout_status'];
		} else {
			$data['config_payment_checkout_status'] = $this->config->get('config_payment_checkout_status');
		}
		...
		// For Google Social Login Credentials
		if (isset($this->request->post['config_social_google_client_id'])) {
			$data['config_social_google_client_id'] = $this->request->post['config_social_google_client_id'];
		} else {
			$data['config_social_google_client_id'] = $this->config->get('config_social_google_client_id');
		}

		if (isset($this->request->post['config_social_google_client_secret'])) {
			$data['config_social_google_client_secret'] = $this->request->post['config_social_google_client_secret'];
		} else {
			$data['config_social_google_client_secret'] = $this->config->get('config_social_google_client_secret');
		}

		// For Facebook Social Login Credentials
		if (isset($this->request->post['config_social_facebook_client_id'])) {
			$data['config_social_facebook_client_id'] = $this->request->post['config_social_facebook_client_id'];
		} else {
			$data['config_social_facebook_client_id'] = $this->config->get('config_social_facebook_client_id');
		}

		if (isset($this->request->post['config_social_facebook_client_secret'])) {
			$data['config_social_facebook_client_secret'] = $this->request->post['config_social_facebook_client_secret'];
		} else {
			$data['config_social_facebook_client_secret'] = $this->config->get('config_social_facebook_client_secret');
		}

		// For Twilio Credentials
		if (isset($this->request->post['config_social_twilio_account_sid'])) {
			$data['config_social_twilio_account_sid'] = $this->request->post['config_social_twilio_account_sid'];
		} else {
			$data['config_social_twilio_account_sid'] = $this->config->get('config_social_twilio_account_sid');
		}

		if (isset($this->request->post['config_social_twilio_auth_token'])) {
			$data['config_social_twilio_auth_token'] = $this->request->post['config_social_twilio_auth_token'];
		} else {
			$data['config_social_twilio_auth_token'] = $this->config->get('config_social_twilio_auth_token');
		}

		if (isset($this->request->post['config_social_twilio_service_sid'])) {
			$data['config_social_twilio_service_sid'] = $this->request->post['config_social_twilio_service_sid'];
		} else {
			$data['config_social_twilio_service_sid'] = $this->config->get('config_social_twilio_service_sid');
		}

		if (isset($this->request->post['config_practo_user'])) {
			$data['config_practo_user'] = $this->request->post['config_practo_user'];
		} else {
			$data['config_practo_user'] = $this->config->get('config_practo_user');
		}
		if (isset($this->request->post['config_practo_password'])) {
			$data['config_practo_password'] = $this->request->post['config_practo_password'];
		} else {
			$data['config_practo_password'] = $this->config->get('config_practo_password');
		}
	...
	protected function validate()
	{
		...
		if ((utf8_strlen($this->request->post['config_practo_user']) < 3) || (utf8_strlen($this->request->post['config_practo_user']) > 32)) {
			$this->error['config_practo_user'] = "Practo User is required."; 
		}
		if ((utf8_strlen($this->request->post['config_practo_password']) < 3) || (utf8_strlen($this->request->post['config_practo_password']) > 32)) {
			$this->error['config_practo_password'] = "Practo Password is required."; 
		}
		// Validate Google Social Login Client ID
		if (isset($this->request->post['config_social_google_client_id'])) {
			$config_social_google_client_id = $this->request->post['config_social_google_client_id'];
			if (utf8_strlen($config_social_google_client_id) < 3 || utf8_strlen($config_social_google_client_id) > 100) {
				$this->error['social_google_client_id'] = 'Google Social Login Client ID must be between 3 and 32 characters long.';
			}
		} else {
			$this->error['social_google_client_id'] = 'Google Social Login Client ID is required.';
		}

		// Validate Google Social Login Client Secret
		if (isset($this->request->post['config_social_google_client_secret'])) {
			$config_social_google_client_secret = $this->request->post['config_social_google_client_secret'];
			if (utf8_strlen($config_social_google_client_secret) < 3 || utf8_strlen($config_social_google_client_secret) > 100) {
				$this->error['social_google_client_secret'] = 'Google Social Login Client Secret must be between 3 and 32 characters long.';
			}
		} else {
			$this->error['social_google_client_secret'] = 'Google Social Login Client Secret is required.';
		}

		if (isset($this->request->post['config_social_facebook_client_id'])) {
			$config_social_facebook_client_id = $this->request->post['config_social_facebook_client_id'];
			if (utf8_strlen($config_social_facebook_client_id) < 3 || utf8_strlen($config_social_facebook_client_id) > 100) {
				$this->error['social_facebook_client_id'] = 'Facebook Social Login Client ID must be between 3 and 32 characters long.';
			}
		} else {
			$this->error['social_facebook_client_id'] = 'Facebook Social Login Client ID is required.';
		}

		// Validate Facebook Social Login Client Secret
		if (isset($this->request->post['config_social_facebook_client_secret'])) {
			$config_social_facebook_client_secret = $this->request->post['config_social_facebook_client_secret'];
			if (utf8_strlen($config_social_facebook_client_secret) < 3 || utf8_strlen($config_social_facebook_client_secret) > 100) {
				$this->error['social_facebook_client_secret'] = 'Facebook Social Login Client Secret must be between 3 and 32 characters long.';
			}
		} else {
			$this->error['social_facebook_client_secret'] = 'Facebook Social Login Client Secret is required.';
		}


		// Validate Twilio Account SID
		if (isset($this->request->post['config_social_twilio_account_sid'])) {
			$config_social_twilio_account_sid = $this->request->post['config_social_twilio_account_sid'];
			if (utf8_strlen($config_social_twilio_account_sid) < 3 || utf8_strlen($config_social_twilio_account_sid) > 100) {
				$this->error['social_twilio_account_sid'] = 'Twilio Account SID must be between 3 and 32 characters long.';
			}
		} else {
			$this->error['social_twilio_account_sid'] = 'Twilio Account SID is required.';
		}

		// Validate Twilio Auth Token
		if (isset($this->request->post['config_social_twilio_auth_token'])) {
			$config_social_twilio_auth_token = $this->request->post['config_social_twilio_auth_token'];
			if (utf8_strlen($config_social_twilio_auth_token) < 3 || utf8_strlen($config_social_twilio_auth_token) > 100) {
				$this->error['social_twilio_auth_token'] = 'Twilio Auth Token must be between 3 and 32 characters long.';
			}
		} else {
			$this->error['social_twilio_auth_token'] = 'Twilio Auth Token is required.';
		}

		// Validate Twilio Number
		if (isset($this->request->post['config_social_twilio_service_sid'])) {
			$config_social_twilio_service_sid = $this->request->post['config_social_twilio_service_sid'];
			if (utf8_strlen($config_social_twilio_service_sid) < 3 || utf8_strlen($config_social_twilio_service_sid) > 100) {
				$this->error['social_twilio_service_sid'] = 'Twilio Service SID must be between 3 and 32 characters long.';
			}
		} else {
			$this->error['social_twilio_service_sid'] = 'Twilio Service SID is required.';
		}
		...
		if ($this->request->post['config_payment_checkout_environment'] == 'live') {
			if ((utf8_strlen($this->request->post['config_payment_checkout_live_secret_key']) < 3)) {
				$this->error['payment_checkout_live_secret_key'] = 'Checkout live secret key is missing';
			}
			if ((utf8_strlen($this->request->post['config_payment_currency']) < 3)) {
				$this->error['payment_currency'] = 'Currency is missing';
			}
			if ((utf8_strlen($this->request->post['config_payment_checkout_live_public_key']) < 3)) {
				$this->error['payment_checkout_live_public_key'] = 'Checkout live public key is missing';
			}
			if ((utf8_strlen($this->request->post['config_payment_checkout_live_channel_id']) < 3)) {
				$this->error['payment_checkout_live_channel_id'] = 'Checkout live channel id is missing';
			}
			if ((utf8_strlen($this->request->post['config_payment_checkout_live_signature_key']) < 3)) {
				$this->error['payment_checkout_live_signature_key'] = 'Checkout live signature key is missing';
			}
		} else {
			if ((utf8_strlen($this->request->post['config_payment_checkout_test_secret_key']) < 3)) {
				$this->error['payment_checkout_test_secret_key'] = 'Checkout test secret key is missing';
			}
			if ((utf8_strlen($this->request->post['config_payment_checkout_test_public_key']) < 3)) {
				$this->error['payment_checkout_test_public_key'] = 'Checkout test public key is missing';
			}
			if ((utf8_strlen($this->request->post['config_payment_checkout_test_channel_id']) < 3)) {
				$this->error['payment_checkout_test_channel_id'] = 'Checkout test channel id is missing';
			}
			if ((utf8_strlen($this->request->post['config_payment_checkout_test_signature_key']) < 3)) {
				$this->error['payment_checkout_test_signature_key'] = 'Checkout test signature key is missing';
			}
		}
