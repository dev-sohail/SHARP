                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="certificatesandresearch_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($certificatesandresearch_description[$lang['language_id']]) ? $certificatesandresearch_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                        ...
                        <div class="tab-pane" id="tab-data"> 
                            <div class="row col-md-12">                    
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group required">
                                        <label class="control-label" for="input-image">Image (185 × 172px)</label>
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                        <img id="bimage" src="../uploads/image/certificatesandresearch/<?= $image ?>" style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } else { ?>
