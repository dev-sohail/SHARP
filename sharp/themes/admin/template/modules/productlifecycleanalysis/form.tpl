                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="productlifecycleanalysis_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($productlifecycleanalysis_description[$lang['language_id']]) ? $productlifecycleanalysis_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea
                                                name="productlifecycleanalysis_description[<?php echo $lang['language_id'] ?>][short_description]"
                                                rows="5" placeholder="Description"
                                                id="input-short-description<?php echo $lang['language_id'] ?>"
                                                class="form-control"><?php echo isset($productlifecycleanalysis_description[$lang['language_id']]) ? $productlifecycleanalysis_description[$lang['language_id']]['short_description'] : ''; ?></textarea>
                        ...
                        <!-- <div class="col-lg-6 col-md-6">
                            ...
                            <div class="row" style="padding-right: 9px;padding-left: 9px;">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                        <img id="bimage" src="../uploads/image/productlifecycleanalysis/<?= $image ?>" style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } else { ?>
