                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="download_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($download_description[$lang['language_id']]) ? $download_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
         ...
         <div class="tab-pane" id="tab-data">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="form-group required">
                    ...
                    <input type="file" name="file" id="input-pdf" class="form-control" accept=".pdf,application/pdf" />
                    ...
                    <div class="col-lg-2 col-md-2 ">
                                <?php if (!empty($file)) { ?>
                                        <a href="../uploads/image/download_files/<?= $file ?>" target="_blank">
