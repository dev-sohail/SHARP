                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="lcareport_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($lcareport_description[$lang['language_id']]) ? $lcareport_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea
                                                name="lcareport_description[<?php echo $lang['language_id'] ?>][short_description]"
                                                rows="5" placeholder="Description"
                                                id="input-short-description<?php echo $lang['language_id'] ?>"
                                                class="form-control"><?php echo isset($lcareport_description[$lang['language_id']]) ? $lcareport_description[$lang['language_id']]['short_description'] : ''; ?></textarea>
                        ...
                        <!-- <div class="col-lg-6 col-md-6">
                            ...
                            <div class="row" style="padding-right: 9px;padding-left: 9px;">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                        <img id="bimage" src="../uploads/image/lcareport/<?= $image ?>" style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } else { ?>
  ...
  <div class="row" style="padding-right: 9px;padding-left: 9px;">
     ...
     <div class="col-lg-4 col-md-4">
        <div class="form-group required">
            ...
            <input type="file" name="pdf" id="input-pdf" class="form-control" accept=".pdf,application/pdf" />
            <?php if (isset($error_pdf)) { ?>
                <div class="text-danger"><?php echo $error_pdf; ?></div>
            <?php } ?>
            <span class="help-block">Upload PDF file (max size: 5MB)</span>

        </div>
  <div class="col-lg-2 col-md-2 ">
            <?php if (!empty($pdf)) { ?>

                    <a href="../uploads/image/lcareport_pdfs/<?= $pdf ?>" target="_blank">
