                                    ...
                                    <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group required">
                                                ...
                                                <input type="text" name="banner_description[<?php echo $lang['language_id'] ?>][title]" value="<?php echo isset($banner_description[$lang['language_id']]) ? $banner_description[$lang['language_id']]['title'] : ''; ?>" placeholder="Title" id="input-title<?php echo $lang['language_id'] ?>" class="form-control" />
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="banner_description[<?php echo $lang['language_id'] ?>][description]" rows="5" placeholder="Short Description" id="input-description<?php echo $lang['language_id'] ?>" class="form-control"><?php echo isset($banner_description[$lang['language_id']]) ? $banner_description[$lang['language_id']]['description'] : ''; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="banner_description[<?php echo $lang['language_id'] ?>][meta_title]" value="<?php echo isset($banner_description[$lang['language_id']]) ? $banner_description[$lang['language_id']]['meta_title'] : ''; ?>" placeholder="Meta Title" id="input-meta_title<?php echo $lang['language_id'] ?>" class="form-control" />
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="banner_description[<?php echo $lang['language_id'] ?>][meta_keyword]" value="<?php echo isset($banner_description[$lang['language_id']]) ? $banner_description[$lang['language_id']]['meta_keyword'] : ''; ?>" placeholder="Meta Keyword" id="input-meta_keyword<?php echo $lang['language_id'] ?>" class="form-control" />
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="banner_description[<?php echo $lang['language_id'] ?>][meta_description]" placeholder="Meta Description" rows="5" id="input-meta_description<?php echo $lang['language_id'] ?>" class="form-control"><?php echo isset($banner_description[$lang['language_id']]) ? $banner_description[$lang['language_id']]['meta_description'] : ''; ?></textarea>
                        ...
                        <div class="tab-pane" id="tab-data">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group required">
                                    <label class="control-label" for="input-url">
                                        <span data-toggle="tooltip" title="SEO Banner Page URL" data-original-title="SEO Banner Page URL">Url</span>
                                    </label>
                            ...
                            <div class="row" style="padding-right: 9px;padding-left: 9px;">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                        <img id="bimage" src="../uploads/image/banner/<?= $image ?>" style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } else { ?>
