...
<p style="color: #ffff; font-family: Arial, sans-serif; font-size: 15px; font-weight: 700;">Phone</p>
</td>
...
<tr>
<td class="td-left" align="left" valign="top" style="padding: 20px 10px 0px 30px; background-color: #77318f;">
<p style="color: #ffff; font-family: Arial, sans-serif; font-size: 15px; font-weight: 700;">Position</p>
</td>
<td class="td-right" align="right" valign="top" style="padding: 20px 30px 0px 10px; background-color: #77318f;">
<p style="color: #ffff; text-align: right; font-variant-numeric: lining-nums proportional-nums; font-family: Arial, sans-serif; font-size: 15px; font-style: normal; font-weight: 400; line-height: normal; ">
<?= $emailData['position'] ?>
...
<tr>
<td class="td-left" align="left" valign="top" style="padding: 20px 10px 0px 30px; background-color: #77318f;">
<p style="color: #ffff; font-family: Arial, sans-serif; font-size: 15px; font-weight: 700;">Address</p>
</td>
<td class="td-right" align="right" valign="top" style="padding: 20px 30px 0px 10px; background-color: #77318f;">
<p style="color: #ffff; text-align: right; font-variant-numeric: lining-nums proportional-nums; font-family: Arial, sans-serif; font-size: 15px; font-style: normal; font-weight: 400; line-height: normal; ">
<?= $emailData['address'] ?>
...
<tr>
<td class="td-left" align="left" valign="top" style="padding: 20px 10px 0px 30px; background-color: #77318f;">
<p style="color: #ffff; font-family: Arial, sans-serif; font-size: 15px; font-weight: 700;">Nationality</p>
</td>
<td class="td-right" align="right" valign="top" style="padding: 20px 30px 0px 10px; background-color: #77318f;">
<p style="color: #ffff; text-align: right; font-variant-numeric: lining-nums proportional-nums; font-family: Arial, sans-serif; font-size: 15px; font-style: normal; font-weight: 400; line-height: normal; ">
<?= $emailData['nationality'] ?>
</p>
</td>
</tr>
<tr>
    <td class="td-left" align="left" valign="top" style="padding: 20px 10px 0px 30px; background-color: #77318f;">
        <p style="color: #ffff; font-family: Arial, sans-serif; font-size: 15px; font-weight: 700;">CV</p>
    </td>
    <td class="td-right" align="right" valign="top" style="padding: 20px 30px 0px 10px; background-color: #77318f;">
        <p style="color: #ffff; text-align: right; font-variant-numeric: lining-nums proportional-nums; font-family: Arial, sans-serif; font-size: 15px; font-style: normal; font-weight: 400; line-height: normal;">
         <a href="<?= $emailData['cv_file'] ?>" style="color: #ffff; text-decoration: none;">URL</a>
        </p>
    </td>
</tr>
<tr class="border" style="padding-bottom: 20px;">
