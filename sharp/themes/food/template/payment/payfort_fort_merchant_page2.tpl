...
//--></script>
<script type="text/javascript" src="themes/bks/js/payfort_fort/jquery.creditCardValidator.js" /> 
<script type="text/javascript" src="themes/bks/js/payfort_fort/payfort_fort.js" />