                  ...
                  <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                    <tr>
                      <td style="background-color: #fff;">
                        <img class="top-sec-img" src="<?php echo 'https://' . $_SERVER['HTTP_HOST']; ?>/uploads/image/slider/pt-home-slider01.jpeg" alt="welcome" style="width: 100%; background-color: #fff;  height:300px; object-fit: cover;">
                      </td>
                    </tr>
                  </table>
                  <!-- Section 2: Heading, Paragraph, and Button -->
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td style="padding: 30px 40px 0px; background-color: #fff;">
                        <h1 class="welcome" style="font-size: 30px; color: #144C60;  font-family: Arial, sans-serif; font-weight: 700; margin-bottom: 30px;"><?php if($forgot){ ?> Reset Password <?php }else{ ?> New Registration <?php } ?></h1>

                        <p class="middle-para" style="color: rgba(20, 76, 96,0.7);  font-family: Arial, sans-serif; font-size: 16px; line-height: 28px; margin-bottom: 26px;"> <?php echo $message; ?></p>
                        <p class="end-para" style="color: rgba(20, 76, 96,0.7);  font-family: Arial, sans-serif; font-size: 16px; line-height: 28px;"></p>
                      </td>
