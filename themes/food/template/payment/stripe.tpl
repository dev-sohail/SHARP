<link rel="stylesheet" type="text/css" href="/themes/nhealth/assets/css/stripe.css">
...
<script type="text/javascript">
    function initStripe() {
        if (window.Stripe) {
            var stripe = Stripe('<?php echo $payment_stripe_public_key; ?>');
            var elements = stripe.elements(<?php if ($locale): ?>{"locale": "<?php echo $locale; ?>"}<?php endif; ?>);
