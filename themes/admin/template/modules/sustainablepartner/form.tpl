            ...
            <div class="col-lg-12 col-md-12">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user"
                    ...
                    <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="sustainablepartner_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($sustainablepartner_description[$lang['language_id']]) ? $sustainablepartner_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea
                                                name="sustainablepartner_description[<?php echo $lang['language_id'] ?>][short_description]"
                                                rows="5" placeholder="Description"
                                                id="input-short-description<?php echo $lang['language_id'] ?>"
                                                class="form-control"><?php echo isset($sustainablepartner_description[$lang['language_id']]) ? $sustainablepartner_description[$lang['language_id']]['short_description'] : ''; ?></textarea>
                        ...
                        <!-- <div class="col-lg-6 col-md-6">
                                <div class="form-group required">
                                    <label class="control-label" for="input-in-date">
                                     Year
                                    </label>
                                    <input type="date" name="date" value="<?php echo $date; ?>"
                                        placeholder="Date" id="input-in-date" class="form-control" />
                                    <?php if ($error_date) { ?>
                                    <div class="text-danger">
                                        <?php echo $error_date; ?>
                                    </div>
                            ...
                            <div class="row" style="padding-right: 9px;padding-left: 9px;">
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group required">
                                        <label class="control-label" for="input-logo">Logo</label>
                                        <input onchange="loadFile(event)" type="file" name="logo" id="logo" accept=".png,.jpg,.jpeg" style="display: block;">
                                    </div>
                                    <?php if ($error_logo) { ?>
                                        <div class="text-danger">
                                            <?php echo $error_logo; ?>
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($logo) { ?>
                                        <img id="blogo" src="../uploads/image/sustainablepartner/<?= $logo ?>" style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } else { ?>
                                        <img id="blogo" src="../uploads/image/no-image.png" style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } ?>
...
<script>
    var loadFile = function(event) {
        ...
        var output = document.getElementById('blogo');
        ...
        if (file) {
            ...
            if (validExtensions.indexOf(extension) === -1 || file.size > maxSize) {
                event.target.value = '';
                alert('Please select a valid file (PNG, JPEG, JPG) less than 1 MB.');
                return false;
            } else {
