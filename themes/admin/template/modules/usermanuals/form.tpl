                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="manual_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($manual_description[$lang['language_id']]) ? $manual_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
