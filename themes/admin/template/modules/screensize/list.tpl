                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input status-toggle"
                                                        id="statusToggle<?php echo $screensize['screensize_id']; ?>"
                                                        <?php echo ($screensize['status']) ? 'checked' : ''; ?>
                                                        data-status-id="<?php echo $screensize['screensize_id']; ?>">
                                                    <label class="custom-control-label"
                                                        for="statusToggle<?php echo $screensize['screensize_id']; ?>">
                                                        <?php echo ($screensize['status']) ? 'Active' : 'Inactive'; ?>
                                                    </label>
                                                </div>
                                            </td>
                                            <td class="text-right">
                                                ...
                                                <form style="display: inline-block;"
                                                    action="<?php echo $screensize['delete']; ?>" method="post"
                                                    enctype="multipart/form-data"
                                                    id="del_screensize<?php echo $screensize['screensize_id']; ?>">
                                                    <input type="hidden" name="screensize_id"
                                                        value="<?php echo $screensize['screensize_id']; ?>">
                                                    <button type="button" data-toggle="tooltip"
                                                        title="<?php echo $button_delete; ?>" class="btn btn-danger"
                                                        onClick='submitDeleteForm("del_screensize<?php echo $screensize['screensize_id']; ?>")'><i
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    rowData[1] =
                        ...
                        screensizeId + '" ' + (newStatus ? 'checked' : '') + ' data-status-id="' +
                        screensizeId + '"> <label class="custom-control-label" for="statusToggle' +
                        screensizeId + '">' + newStatusText + '</label> </div>';
