...
<div class="main-panel">
    <div class="sec-head">
        ...
        <div class="sec-head-btns">
            ...
            <button type="submit" form="form-screensize" data-toggle="tooltip" title="<?php echo 'Save'; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="main-employee-box">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-screensize" class="form-horizontal">
                                    ...
                                    <div class="tab-pane" id="language<?php echo $language['language_id'] ?>">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group required">
                                                ...
                                                <input type="text" name="screensize_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($screensize_description[$language['language_id']]['title']) ? $screensize_description[$language['language_id']]['title'] : ''; ?>" placeholder="Title" id="input-title-<?php echo $language['language_id']; ?>" class="form-control" />
                    ...
                    <div class="col-lg-6 col-md-6 bottom-inline-btns">
                        <button type="submit" form="form-screensize" data-toggle="tooltip" title="Save" class="btn btn-success"> <i class="fa fa-save"></i> Submit</button>
