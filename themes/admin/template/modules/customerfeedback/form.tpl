                            ...
                            <div class="tab-content">
                                ...
                                <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="feedback_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($feedback_description[$lang['language_id']]) ? $feedback_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            <label class="control-label"
                                                for="input-meta-designation<?php echo $lang['language_id'] ?>">
                                                Designation
                                            </label>
                                            <input type="text"
                                                name="feedback_description[<?php echo $lang['language_id'] ?>][designation]"
                                                value="<?php echo isset($feedback_description[$lang['language_id']]) ? $feedback_description[$lang['language_id']]['designation'] : ''; ?>"
                                                placeholder="Designation"
                                                id="input-meta-designation<?php echo $lang['language_id'] ?>"
                                                class="form-control" />
                                            <?php if (isset($error_designation[$lang['language_id']])) { ?>
                                            <div class="text-danger">
                                                <?php echo $error_designation[$lang['language_id']]; ?>
                                            </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea
                                                name="feedback_description[<?php echo $lang['language_id'] ?>][description]"
                                                rows="5" placeholder="Description"
                                                id="input-description<?php echo $lang['language_id'] ?>"
                                                class="form-control"><?php echo isset($feedback_description[$lang['language_id']]) ? $feedback_description[$lang['language_id']]['description'] : ''; ?></textarea>
                            ...
                            <div class="row col-md-12">                    
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <input onchange="loadFile(event)" type="file" name="icon" id="icon" accept=".png,.jpg,.jpeg" style="display: block;">
                                    </div>
                                    <?php if ($error_icon) { ?>
                                        <div class="text-danger">
                                            <?php echo $error_icon; ?>
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($icon) { ?>
                                        <img id="bimage" src="../uploads/image/customer_feedback/<?= $icon ?>" style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } else { ?>
