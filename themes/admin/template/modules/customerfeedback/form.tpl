<!--
    ...
    ------------------------------
    This template renders the add/edit Customer Feedback form in the admin panel.
    - Supports multilingual input for title, designation, and description.
    - Includes controls for icon upload, number of stars, sort order, and status.
    - Displays validation and success messages.
    - Uses Bootstrap and custom styles for layout and appearance.
...
<div class="main-panel">
    <div class="sec-head">
        ...
        <div class="sec-head-btns">
            ...
            <button type="submit" form="form-customerfeedback" data-toggle="tooltip" title="<?php echo 'Save'; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="main-employee-box">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customerfeedback" class="form-horizontal">
                                    ...
                                    <div class="tab-pane" id="language<?php echo $language['language_id'] ?>">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group required">
                                                ...
                                                <input type="text" name="feedback_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($feedback_description[$language['language_id']]['title']) ? $feedback_description[$language['language_id']]['title'] : ''; ?>" placeholder="Title" id="input-title-<?php echo $language['language_id']; ?>" class="form-control" />
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <input type="text" name="feedback_description[<?php echo $language['language_id']; ?>][designation]" value="<?php echo isset($feedback_description[$language['language_id']]['designation']) ? $feedback_description[$language['language_id']]['designation'] : ''; ?>" placeholder="Designation" id="input-designation-<?php echo $language['language_id']; ?>" class="form-control" />
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <textarea name="feedback_description[<?php echo $language['language_id']; ?>][description]" placeholder="Description" id="input-description-<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($feedback_description[$language['language_id']]['description']) ? $feedback_description[$language['language_id']]['description'] : ''; ?></textarea>
