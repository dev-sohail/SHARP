                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group required">
                                                ...
                                                <input type="text" name="media_center_description[<?php echo $lang['language_id'] ?>][title]" value="<?php echo isset($media_center_description[$lang['language_id']]) ? $media_center_description[$lang['language_id']]['title'] : ''; ?>" placeholder="Title" id="input-title<?php echo $lang['language_id'] ?>" class="form-control" />
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group required">
                                                ...
                                                <textarea name="media_center_description[<?php echo $lang['language_id'] ?>][short_description]" rows="5" placeholder="Short Description" id="input-short_description<?php echo $lang['language_id'] ?>" class="form-control"><?php echo isset($media_center_description[$lang['language_id']]) ? $media_center_description[$lang['language_id']]['short_description'] : ''; ?></textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group required">
                                                ...
                                                <textarea name="media_center_description[<?php echo $lang['language_id'] ?>][description]" placeholder="Description" id="input-description<?php echo $lang['language_id'] ?>" class="form-control"> <?php echo isset($media_center_description[$lang['language_id']]) ? $media_center_description[$lang['language_id']]['description'] : ''; ?></textarea>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="media_center_description[<?php echo $lang['language_id'] ?>][meta_title]" value="<?php echo isset($media_center_description[$lang['language_id']]) ? $media_center_description[$lang['language_id']]['meta_title'] : ''; ?>" placeholder="Meta Title" id="input-meta_title<?php echo $lang['language_id'] ?>" class="form-control" />
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="media_center_description[<?php echo $lang['language_id'] ?>][meta_keyword]" value="<?php echo isset($media_center_description[$lang['language_id']]) ? $media_center_description[$lang['language_id']]['meta_keyword'] : ''; ?>" placeholder="Meta Keyword" id="input-meta_keyword<?php echo $lang['language_id'] ?>" class="form-control" />
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="media_center_description[<?php echo $lang['language_id'] ?>][meta_description]" placeholder="Meta Description" rows="5" id="input-meta_description<?php echo $lang['language_id'] ?>" class="form-control"><?php echo isset($media_center_description[$lang['language_id']]) ? $media_center_description[$lang['language_id']]['meta_description'] : ''; ?></textarea>
                        ...
                        <div class="tab-pane" id="tab-data">
                            ...
                            <div class="col-lg-6 col-md-6">
                             ...
                             <div class="row col-md-12">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($thumbnail) { ?>
                                    <img id="bimage" src="../uploads/image/mediacenter/<?= $thumbnail ?>"
                            ...
                            <div class="row col-md-12">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($banner_image) { ?>
                                    <img id="bimage1" src="../uploads/image/mediacenter/<?= $banner_image ?>"
                                        style="width: 100%; height: 89px;margin-top: 12px;">
                                    <?php } else { ?>
...
<script>
    var loadFilepdf = function(event, outputElementId, hiddenField) {
    var file = event.target.files[0];
    const fileHiddenField = document.getElementById(hiddenField);
    ...
    if (file) {
        ...
        if (validExtensions.indexOf(extension) === -1 || file.size > maxSize) {
            event.target.value = '';
            alert('Please select a valid PDF file less than 10 MB.');
            return false;
        } else {
            output.innerHTML = `<a href="${URL.createObjectURL(file)}" target="_blank">View PDF</a>`;
            output.onload = function() {
                URL.revokeObjectURL(output.href);
            };
            fileHiddenField.value = file.name;
        }
    }
};
function deleteFile(hiddenField, outputElementId) {
    const output = document.getElementById(outputElementId);
    const hiddenInput = document.getElementById(hiddenField);
    output.innerHTML = 'No PDF uploaded';
    hiddenInput.value = '';
}
</script>
